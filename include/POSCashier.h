...
public:
    ...
    // CREATE
    void saveTransaction(string productNames, string productQuantities, double initialAmount, double totalAmount, double discount, double moneyTendered, double change, string cashierName, string paymentMethod, long long referenceID); // used to log transactions on the transactions folder
